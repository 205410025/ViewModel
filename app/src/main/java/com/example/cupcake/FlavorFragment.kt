...
/**
 * [FlavorFragment] memungkinkan user memilih rasa donat untuk pesanan.
 */
class FlavorFragment : Fragment() {
    ...
    // Delegasi properti Kotlin 'by activityViewModels()' dari artefak fragmen-ktx
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.apply {
            ...
            // Tetapkan model tampilan ke properti di bidding class
    ...
    /**
     * Navigasi untuk lanjut ke halaman choose pickup date.
     */
    fun goToNextScreen() {
