...
class StartFragment : Fragment() {
    ...
    /**
     * Mulai pesanan dengan jumlah donat yang diinginkan dan navigasikan ke layar berikutnya.
     */
    fun orderCupcake(quantity: Int) {
        ...
        // Navigasikan ke tujuan berikutnya untuk memilih rasa donat
        findNavController().navigate(R.id.action_startFragment_to_flavorFragment)
    }

    /**
     * Metode siklus hidup fragmen ini dipanggil saat hierarki view terkait dengan fragmen
